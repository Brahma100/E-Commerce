...
function validateGraphQlDocuments(schema, documentFiles, effectiveRules) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const allErrors = [];
        yield Promise.all(documentFiles.map((documentFile) => __awaiter(this, void 0, void 0, function* () {
...
function buildFixedSchema(schema, options) {
    return graphql.buildSchema(printSchemaWithDirectives(schema, options), Object.assign({ noLocation: true }, (options || {})));
}
...
function transformCommentsToDescriptions(sourceSdl, options = {}) {
    const parsedDoc = graphql.parse(sourceSdl, Object.assign(Object.assign({}, options), { noLocation: false }));
        ...
        leave: (node) => {
            if (isDescribable(node)) {
                ...
                if (rawValue !== undefined) {
                    ...
                    if (!node.description) {
                        return Object.assign(Object.assign({}, node), { description: {
                        ...
                        return Object.assign(Object.assign({}, node), { description: Object.assign(Object.assign({}, node.description), { value: node.description.value + '\n' + commentsBlock, block: true }) });
                    }
                }
            }
        },
...
function resolveField({ type, field, models, firstCall, path, ancestors, ignore, depthLimit, circularReferenceDepth, schema, depth, argNames, selectedFields, }) {
    ...
    if (!graphql.isScalarType(namedType) && !graphql.isEnumType(namedType)) {
        return Object.assign(Object.assign({ kind: graphql.Kind.FIELD, name: {
                kind: graphql.Kind.NAME,
                value: field.name,
...
function mapEnumValues(originalTypeMap, schema, schemaMapper) {
    ...
    return mapTypes(originalTypeMap, schema, {
        [exports.MapperKind.ENUM_TYPE]: type => {
            ...
            return correctASTNodes(new graphql.GraphQLEnumType(Object.assign(Object.assign({}, config), { values: newEnumValueConfigMap })));
        },
...
function mapDefaultValues(originalTypeMap, schema, fn) {
    const newTypeMap = mapArguments(originalTypeMap, schema, {
        [exports.MapperKind.ARGUMENT]: argumentConfig => {
            ...
            if (maybeNewType != null) {
                return Object.assign(Object.assign({}, argumentConfig), { defaultValue: fn(maybeNewType, argumentConfig.defaultValue) });
            }
        },
    });
    return mapFields(newTypeMap, schema, {
        [exports.MapperKind.INPUT_OBJECT_FIELD]: inputFieldConfig => {
            ...
            if (maybeNewType != null) {
                return Object.assign(Object.assign({}, inputFieldConfig), { defaultValue: fn(maybeNewType, inputFieldConfig.defaultValue) });
            }
        },
    });
}
    ...
    Object.keys(originalTypeMap).forEach(typeName => {
        if (!typeName.startsWith('__')) {
            ...
            Object.keys(originalFieldConfigMap).forEach(fieldName => {
                ...
                if (mappedField === undefined) {
                    ...
                    if (newFieldConfig.astNode != null) {
                        newFieldConfig.astNode = Object.assign(Object.assign({}, newFieldConfig.astNode), { name: Object.assign(Object.assign({}, newFieldConfig.astNode.name), { value: newFieldName }) });
                    }
            ...
            if (graphql.isObjectType(originalType)) {
                newTypeMap[typeName] = correctASTNodes(new graphql.GraphQLObjectType(Object.assign(Object.assign({}, config), { fields: newFieldConfigMap })));
            }
            else if (graphql.isInterfaceType(originalType)) {
                newTypeMap[typeName] = correctASTNodes(new graphql.GraphQLInterfaceType(Object.assign(Object.assign({}, config), { fields: newFieldConfigMap })));
            }
            else {
                newTypeMap[typeName] = correctASTNodes(new graphql.GraphQLInputObjectType(Object.assign(Object.assign({}, config), { fields: newFieldConfigMap })));
            }
        }
    });
    return newTypeMap;
    ...
    Object.keys(originalTypeMap).forEach(typeName => {
        if (!typeName.startsWith('__')) {
            ...
            Object.keys(originalFieldConfigMap).forEach(fieldName => {
                ...
                newFieldConfigMap[fieldName] = Object.assign(Object.assign({}, originalFieldConfig), { args: newArgumentConfigMap });
            });
            if (graphql.isObjectType(originalType)) {
                newTypeMap[typeName] = new graphql.GraphQLObjectType(Object.assign(Object.assign({}, config), { fields: newFieldConfigMap }));
            }
            else if (graphql.isInterfaceType(originalType)) {
                newTypeMap[typeName] = new graphql.GraphQLInterfaceType(Object.assign(Object.assign({}, config), { fields: newFieldConfigMap }));
            }
            else {
                newTypeMap[typeName] = new graphql.GraphQLInputObjectType(Object.assign(Object.assign({}, config), { fields: newFieldConfigMap }));
            }
        }
    });
    return newTypeMap;
...
function correctASTNodes(type) {
    if (graphql.isObjectType(type)) {
        ...
        if (config.astNode != null) {
            ...
            config.astNode = Object.assign(Object.assign({}, config.astNode), { kind: graphql.Kind.OBJECT_TYPE_DEFINITION, fields });
        }
        if (config.extensionASTNodes != null) {
            config.extensionASTNodes = config.extensionASTNodes.map(node => (Object.assign(Object.assign({}, node), { kind: graphql.Kind.OBJECT_TYPE_EXTENSION, fields: undefined })));
        }
        ...
        if (config.astNode != null) {
            ...
            config.astNode = Object.assign(Object.assign({}, config.astNode), { kind: graphql.Kind.INTERFACE_TYPE_DEFINITION, fields });
        }
        if (config.extensionASTNodes != null) {
            config.extensionASTNodes = config.extensionASTNodes.map(node => (Object.assign(Object.assign({}, node), { kind: graphql.Kind.INTERFACE_TYPE_EXTENSION, fields: undefined })));
        }
        ...
        if (config.astNode != null) {
            ...
            config.astNode = Object.assign(Object.assign({}, config.astNode), { kind: graphql.Kind.INPUT_OBJECT_TYPE_DEFINITION, fields });
        }
        if (config.extensionASTNodes != null) {
            config.extensionASTNodes = config.extensionASTNodes.map(node => (Object.assign(Object.assign({}, node), { kind: graphql.Kind.INPUT_OBJECT_TYPE_EXTENSION, fields: undefined })));
        }
        ...
        if (config.astNode != null) {
            ...
            config.astNode = Object.assign(Object.assign({}, config.astNode), { values });
        }
        if (config.extensionASTNodes != null) {
            config.extensionASTNodes = config.extensionASTNodes.map(node => (Object.assign(Object.assign({}, node), { values: undefined })));
        }
...
function cloneType(type) {
    if (graphql.isObjectType(type)) {
        const config = type.toConfig();
        return new graphql.GraphQLObjectType(Object.assign(Object.assign({}, config), { interfaces: typeof config.interfaces === 'function' ? config.interfaces : config.interfaces.slice() }));
    }
    else if (graphql.isInterfaceType(type)) {
        const config = type.toConfig();
        const newConfig = Object.assign(Object.assign({}, config), { interfaces: [...((typeof config.interfaces === 'function' ? config.interfaces() : config.interfaces) || [])] });
        return new graphql.GraphQLInterfaceType(newConfig);
    }
    else if (graphql.isUnionType(type)) {
        const config = type.toConfig();
...
function renameFieldNode(fieldNode, name) {
    return Object.assign(Object.assign({}, fieldNode), { alias: {
            kind: graphql.Kind.NAME,
        ...
        switch (node.kind) {
            case 'Field': {
                if (node.alias != null) {
                    ...
                    return Object.assign(Object.assign({}, map), { [node.alias.value]: node });
                }
                if (node.name.value in map) {
                    return map;
                }
                return Object.assign(Object.assign({}, map), { [node.name.value]: node });
            }
            case 'FragmentSpread': {
                if (node.name.value in map) {
                    return map;
            ...
            case 'InlineFragment': {
                if (map.__fragment != null) {
                    ...
                    return Object.assign(Object.assign({}, map), { __fragment: concatInlineFragments(fragment.typeCondition.name.value, [fragment, node]) });
                }
                return Object.assign(Object.assign({}, map), { __fragment: node });
            }
            default: {
                return map;
            }
    ...
    return mapSchema(schema, {
        [exports.MapperKind.OBJECT_TYPE]: type => {
            if (type.name === typeName) {
                ...
                return correctASTNodes(new graphql.GraphQLObjectType(Object.assign(Object.assign({}, config), { fields: newFieldConfigMap })));
            }
        },
    });
}
...
function renameType(type, newTypeName) {
    if (graphql.isObjectType(type)) {
        return new graphql.GraphQLObjectType(Object.assign(Object.assign({}, type.toConfig()), { name: newTypeName, astNode: type.astNode == null
                ? type.astNode
                : Object.assign(Object.assign({}, type.astNode), { name: Object.assign(Object.assign({}, type.astNode.name), { value: newTypeName }) }), extensionASTNodes: type.extensionASTNodes == null
                ? type.extensionASTNodes
                : type.extensionASTNodes.map(node => (Object.assign(Object.assign({}, node), { name: Object.assign(Object.assign({}, node.name), { value: newTypeName }) }))) }));
    }
    else if (graphql.isInterfaceType(type)) {
        return new graphql.GraphQLInterfaceType(Object.assign(Object.assign({}, type.toConfig()), { name: newTypeName, astNode: type.astNode == null
                ? type.astNode
                : Object.assign(Object.assign({}, type.astNode), { name: Object.assign(Object.assign({}, type.astNode.name), { value: newTypeName }) }), extensionASTNodes: type.extensionASTNodes == null
                ? type.extensionASTNodes
                : type.extensionASTNodes.map(node => (Object.assign(Object.assign({}, node), { name: Object.assign(Object.assign({}, node.name), { value: newTypeName }) }))) }));
        ...
        return new graphql.GraphQLUnionType(Object.assign(Object.assign({}, type.toConfig()), { name: newTypeName, astNode: type.astNode == null
                ? type.astNode
                : Object.assign(Object.assign({}, type.astNode), { name: Object.assign(Object.assign({}, type.astNode.name), { value: newTypeName }) }), extensionASTNodes: type.extensionASTNodes == null
                ? type.extensionASTNodes
                : type.extensionASTNodes.map(node => (Object.assign(Object.assign({}, node), { name: Object.assign(Object.assign({}, node.name), { value: newTypeName }) }))) }));
        ...
        return new graphql.GraphQLInputObjectType(Object.assign(Object.assign({}, type.toConfig()), { name: newTypeName, astNode: type.astNode == null
                ? type.astNode
                : Object.assign(Object.assign({}, type.astNode), { name: Object.assign(Object.assign({}, type.astNode.name), { value: newTypeName }) }), extensionASTNodes: type.extensionASTNodes == null
                ? type.extensionASTNodes
                : type.extensionASTNodes.map(node => (Object.assign(Object.assign({}, node), { name: Object.assign(Object.assign({}, node.name), { value: newTypeName }) }))) }));
        ...
        return new graphql.GraphQLEnumType(Object.assign(Object.assign({}, type.toConfig()), { name: newTypeName, astNode: type.astNode == null
                ? type.astNode
                : Object.assign(Object.assign({}, type.astNode), { name: Object.assign(Object.assign({}, type.astNode.name), { value: newTypeName }) }), extensionASTNodes: type.extensionASTNodes == null
                ? type.extensionASTNodes
                : type.extensionASTNodes.map(node => (Object.assign(Object.assign({}, node), { name: Object.assign(Object.assign({}, node.name), { value: newTypeName }) }))) }));
        ...
        return new graphql.GraphQLScalarType(Object.assign(Object.assign({}, type.toConfig()), { name: newTypeName, astNode: type.astNode == null
                ? type.astNode
                : Object.assign(Object.assign({}, type.astNode), { name: Object.assign(Object.assign({}, type.astNode.name), { value: newTypeName }) }), extensionASTNodes: type.extensionASTNodes == null
                ? type.extensionASTNodes
                : type.extensionASTNodes.map(node => (Object.assign(Object.assign({}, node), { name: Object.assign(Object.assign({}, node.name), { value: newTypeName }) }))) }));
...
function observableToAsyncIterable(observable) {
    ...
    const pullValue = () => new Promise(resolve => {
        if (pushQueue.length !== 0) {
            ...
            resolve(Object.assign(Object.assign({}, element), { done: false }));
        }
        else {
