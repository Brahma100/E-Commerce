...
function buildFixedSchema(schema, options) {
    return buildSchema(printSchemaWithDirectives(schema, options), Object.assign({ noLocation: true }, (options || {})));
}
...
function transformCommentsToDescriptions(sourceSdl, options = {}) {
    const parsedDoc = parse(sourceSdl, Object.assign(Object.assign({}, options), { noLocation: false }));
...
function resolveField({ type, field, models, firstCall, path, ancestors, ignore, depthLimit, circularReferenceDepth, schema, depth, argNames, selectedFields, }) {
    ...
    if (!isScalarType(namedType) && !isEnumType(namedType)) {
        return Object.assign(Object.assign({ kind: Kind.FIELD, name: {
                kind: Kind.NAME,
                value: field.name,
...
function mapEnumValues(originalTypeMap, schema, schemaMapper) {
    ...
    return mapTypes(originalTypeMap, schema, {
        [MapperKind.ENUM_TYPE]: type => {
            ...
            return correctASTNodes(new GraphQLEnumType(Object.assign(Object.assign({}, config), { values: newEnumValueConfigMap })));
        },
    ...
    Object.keys(originalTypeMap).forEach(typeName => {
        if (!typeName.startsWith('__')) {
            ...
            if (isObjectType(originalType)) {
                newTypeMap[typeName] = correctASTNodes(new GraphQLObjectType(Object.assign(Object.assign({}, config), { fields: newFieldConfigMap })));
            }
            else if (isInterfaceType(originalType)) {
                newTypeMap[typeName] = correctASTNodes(new GraphQLInterfaceType(Object.assign(Object.assign({}, config), { fields: newFieldConfigMap })));
            }
            else {
                newTypeMap[typeName] = correctASTNodes(new GraphQLInputObjectType(Object.assign(Object.assign({}, config), { fields: newFieldConfigMap })));
            }
        }
    });
    return newTypeMap;
...
function mapArguments(originalTypeMap, schema, schemaMapper) {
    ...
    Object.keys(originalTypeMap).forEach(typeName => {
        if (!typeName.startsWith('__')) {
            ...
            if (isObjectType(originalType)) {
                newTypeMap[typeName] = new GraphQLObjectType(Object.assign(Object.assign({}, config), { fields: newFieldConfigMap }));
            }
            else if (isInterfaceType(originalType)) {
                newTypeMap[typeName] = new GraphQLInterfaceType(Object.assign(Object.assign({}, config), { fields: newFieldConfigMap }));
            }
            else {
                newTypeMap[typeName] = new GraphQLInputObjectType(Object.assign(Object.assign({}, config), { fields: newFieldConfigMap }));
            }
        }
    });
    return newTypeMap;
...
function correctASTNodes(type) {
    if (isObjectType(type)) {
        ...
        if (config.astNode != null) {
            ...
            config.astNode = Object.assign(Object.assign({}, config.astNode), { kind: Kind.OBJECT_TYPE_DEFINITION, fields });
        }
        if (config.extensionASTNodes != null) {
            config.extensionASTNodes = config.extensionASTNodes.map(node => (Object.assign(Object.assign({}, node), { kind: Kind.OBJECT_TYPE_EXTENSION, fields: undefined })));
        }
        ...
        if (config.astNode != null) {
            ...
            config.astNode = Object.assign(Object.assign({}, config.astNode), { kind: Kind.INTERFACE_TYPE_DEFINITION, fields });
        }
        if (config.extensionASTNodes != null) {
            config.extensionASTNodes = config.extensionASTNodes.map(node => (Object.assign(Object.assign({}, node), { kind: Kind.INTERFACE_TYPE_EXTENSION, fields: undefined })));
        }
        ...
        if (config.astNode != null) {
            ...
            config.astNode = Object.assign(Object.assign({}, config.astNode), { kind: Kind.INPUT_OBJECT_TYPE_DEFINITION, fields });
        }
        if (config.extensionASTNodes != null) {
            config.extensionASTNodes = config.extensionASTNodes.map(node => (Object.assign(Object.assign({}, node), { kind: Kind.INPUT_OBJECT_TYPE_EXTENSION, fields: undefined })));
        }
...
function cloneType(type) {
    if (isObjectType(type)) {
        const config = type.toConfig();
        return new GraphQLObjectType(Object.assign(Object.assign({}, config), { interfaces: typeof config.interfaces === 'function' ? config.interfaces : config.interfaces.slice() }));
    }
    else if (isInterfaceType(type)) {
        const config = type.toConfig();
    ...
    return mapSchema(schema, {
        [MapperKind.OBJECT_TYPE]: type => {
            if (type.name === typeName) {
                ...
                return correctASTNodes(new GraphQLObjectType(Object.assign(Object.assign({}, config), { fields: newFieldConfigMap })));
            }
        },
    });
}
...
function renameType(type, newTypeName) {
    if (isObjectType(type)) {
        return new GraphQLObjectType(Object.assign(Object.assign({}, type.toConfig()), { name: newTypeName, astNode: type.astNode == null
                ? type.astNode
        ...
        return new GraphQLInterfaceType(Object.assign(Object.assign({}, type.toConfig()), { name: newTypeName, astNode: type.astNode == null
                ? type.astNode
                : Object.assign(Object.assign({}, type.astNode), { name: Object.assign(Object.assign({}, type.astNode.name), { value: newTypeName }) }), extensionASTNodes: type.extensionASTNodes == null
                ? type.extensionASTNodes
                : type.extensionASTNodes.map(node => (Object.assign(Object.assign({}, node), { name: Object.assign(Object.assign({}, node.name), { value: newTypeName }) }))) }));
        ...
        return new GraphQLUnionType(Object.assign(Object.assign({}, type.toConfig()), { name: newTypeName, astNode: type.astNode == null
                ? type.astNode
                : Object.assign(Object.assign({}, type.astNode), { name: Object.assign(Object.assign({}, type.astNode.name), { value: newTypeName }) }), extensionASTNodes: type.extensionASTNodes == null
                ? type.extensionASTNodes
                : type.extensionASTNodes.map(node => (Object.assign(Object.assign({}, node), { name: Object.assign(Object.assign({}, node.name), { value: newTypeName }) }))) }));
        ...
        return new GraphQLInputObjectType(Object.assign(Object.assign({}, type.toConfig()), { name: newTypeName, astNode: type.astNode == null
                ? type.astNode
                : Object.assign(Object.assign({}, type.astNode), { name: Object.assign(Object.assign({}, type.astNode.name), { value: newTypeName }) }), extensionASTNodes: type.extensionASTNodes == null
                ? type.extensionASTNodes
                : type.extensionASTNodes.map(node => (Object.assign(Object.assign({}, node), { name: Object.assign(Object.assign({}, node.name), { value: newTypeName }) }))) }));
        ...
        return new GraphQLEnumType(Object.assign(Object.assign({}, type.toConfig()), { name: newTypeName, astNode: type.astNode == null
                ? type.astNode
                : Object.assign(Object.assign({}, type.astNode), { name: Object.assign(Object.assign({}, type.astNode.name), { value: newTypeName }) }), extensionASTNodes: type.extensionASTNodes == null
                ? type.extensionASTNodes
                : type.extensionASTNodes.map(node => (Object.assign(Object.assign({}, node), { name: Object.assign(Object.assign({}, node.name), { value: newTypeName }) }))) }));
        ...
        return new GraphQLScalarType(Object.assign(Object.assign({}, type.toConfig()), { name: newTypeName, astNode: type.astNode == null
                ? type.astNode
                : Object.assign(Object.assign({}, type.astNode), { name: Object.assign(Object.assign({}, type.astNode.name), { value: newTypeName }) }), extensionASTNodes: type.extensionASTNodes == null
                ? type.extensionASTNodes
                : type.extensionASTNodes.map(node => (Object.assign(Object.assign({}, node), { name: Object.assign(Object.assign({}, node.name), { value: newTypeName }) }))) }));
