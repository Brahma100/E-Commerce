    ...
    return utils.mapSchema(schema, {
        [utils.MapperKind.ROOT_OBJECT]: type => {
            ...
            Object.keys(fieldConfigMap).forEach(fieldName => {
                fieldConfigMap[fieldName] = Object.assign(Object.assign({}, fieldConfigMap[fieldName]), proxyingResolvers[type.name][fieldName]);
            });
...
class RenameTypes {
    ...
    transformRequest(originalRequest) {
        ...
        return Object.assign(Object.assign({}, originalRequest), { document });
    }
    transformResult(result) {
        return Object.assign(Object.assign({}, result), { data: utils.visitData(result.data, object => {
...
class TransformCompositeFields {
    ...
    transformRequest(originalRequest, _delegationContext, transformationContext) {
        ...
        return Object.assign(Object.assign({}, originalRequest), { document: this.transformDocument(document, fragments, transformationContext) });
    }
    ...
    transformSelectionSet(node, typeInfo, fragments, transformationContext) {
        ...
        node.selections.forEach(selection => {
            ...
            newSelections.push(Object.assign(Object.assign({}, transformedSelection), { name: {
                    kind: graphql.Kind.NAME,
                    value: oldName,
                }, alias: {
                    kind: graphql.Kind.NAME,
        ...
        return Object.assign(Object.assign({}, node), { selections: newSelections });
    }
}
                        ...
                        node.fields.forEach(inputField => {
                            ...
                            if (Array.isArray(transformedInputField)) {
                                transformedInputField.forEach(individualTransformedInputField => {
                                    ...
                                    newInputFields.push(Object.assign(Object.assign({}, individualTransformedInputField), { name: Object.assign(Object.assign({}, individualTransformedInputField.name), { value: oldName }) }));
                                });
                                return;
                            }
                            const typeMapping = mapping[parentTypeName];
                            ...
                            newInputFields.push(Object.assign(Object.assign({}, transformedInputField), { name: Object.assign(Object.assign({}, transformedInputField.name), { value: oldName }) }));
                        });
                        const newNode = Object.assign(Object.assign({}, node), { fields: newInputFields });
...
class RenameInputObjectFields {
    constructor(renamer) {
        ...
        this.transformer = new TransformInputObjectFields((typeName, inputFieldName, inputFieldConfig) => {
            ...
            return Object.assign(Object.assign({}, inputFieldNode), { name: Object.assign(Object.assign({}, inputFieldNode.name), { value: inputFieldNameMap[inputFieldName] }) });
        });
        this.reverseMap = Object.create(null);
    }
    transformSchema(originalSchema) {
...
class MapLeafValues {
    ...
    transformRequest(originalRequest, _delegationContext, transformationContext) {
        ...
        const transformedRequest = Object.assign(Object.assign({}, originalRequest), { document: Object.assign(Object.assign({}, document), { definitions: [...newOperations, ...fragments] }), variables: variableValues });
    ...
    transformOperations(operations, variableValues) {
        return operations.map((operation) => {
            const variableDefinitionMap = operation.variableDefinitions.reduce((prev, def) => (Object.assign(Object.assign({}, prev), { [def.variable.name.value]: def })), {});
            ...
            return Object.assign(Object.assign({}, newOperation), { variableDefinitions: Object.keys(variableDefinitionMap).map(varName => variableDefinitionMap[varName]) });
        });
    }
    transformFieldNode(field, variableDefinitionMap, variableValues) {
        ...
        if (!targetField.name.startsWith('__')) {
            ...
            if (argumentNodes != null) {
                const argumentNodeMap = argumentNodes.reduce((prev, argument) => (Object.assign(Object.assign({}, prev), { [argument.name.value]: argument })), Object.create(null));
                ...
                return Object.assign(Object.assign({}, field), { arguments: Object.keys(argumentNodeMap).map(argName => argumentNodeMap[argName]) });
            }
        }
    }
}
            ...
            [graphql.Kind.FIELD]: {
                enter: node => {
                    ...
                    if (index === pathLength) {
                        ...
                        return Object.assign(Object.assign({}, node), { selectionSet });
                    }
                },
                leave: () => {
                    index--;
            ...
            [graphql.Kind.FIELD]: {
                enter: (node) => {
                    ...
                    if (ourPathTo === JSON.stringify(fieldPath) && fromSelection != null) {
                        return Object.assign(Object.assign({}, node), { selectionSet: fromSelection });
                    }
                },
                leave: () => {
                    fieldPath.pop();
...
function introspectSchema(executor, context, options) {
    return tslib.__awaiter(this, void 0, void 0, function* () {
        ...
        const introspectionResult = yield executor({
